...
/*
 * @file State_Bounding_Real_SLIP.h
...
#ifndef BOUNDING_REAL_SLIP_H
#define BOUNDING_REAL_SLIP_H
...
class State_Bounding_Real_SLIP : public FSMState{
public:
    State_Bounding_Real_SLIP(CtrlComponents *ctrlComp);
    ~State_Bounding_Real_SLIP();
    void enter(); 
    void run();
    void exit();
