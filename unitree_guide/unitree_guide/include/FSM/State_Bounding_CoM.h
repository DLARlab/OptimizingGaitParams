...
***********************************************************************/
#ifndef BOUNDING_COM_H
#define BOUNDING_COM_H
...
class State_Bounding_CoM : public FSMState{
public:
    State_Bounding_CoM(CtrlComponents *ctrlComp);
    ~State_Bounding_CoM();
    void enter();
    void run();
    void exit();
...
private:
    ...
    std::ofstream file_dq0, file_dq1, file_dq2, file_dq3, file_dq4, file_dq5, file_dq6, file_dq7, file_dq8, file_dq9, file_dq10, file_dq11;
    std::ofstream file_tauM0, file_tauM1, file_tauM2, file_tauM3, file_tauM4, file_tauM5, file_tauM6, file_tauM7, file_tauM8, file_tauM9, file_tauM10, file_tauM11;
    ...
    // Rob State
    Vec3  _posBody, _velBody, _VelFhc, _VelFRc, _wPosFhc, _wPosRhc; // Vec3, position and velocity of the torso in  in world frame
    ...
    Vec12 _q, _qGoal12, _dq, _tauM; // Vec12, joint angles
    // Robot command
    Vec3 _pcd;
